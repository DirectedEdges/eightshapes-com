...
glob("src/_components/**/*.njk", {}, function (er, files) {
  ...
  let concatenatedContents = "{# This file is automatically generated by the concatenate-component-macros.js build task, do not edit directly #}\n{% import '../../node_modules/esds-library/components/esds.njk' as esds %}\n"; // Import the esds components first, so the escom components have access to them
